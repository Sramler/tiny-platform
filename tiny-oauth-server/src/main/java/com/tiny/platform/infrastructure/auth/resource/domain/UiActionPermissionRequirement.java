...
@Entity
@Table(name = "ui_action_permission_requirement")
public class UiActionPermissionRequirement {
    ...
    @Column(name = "ui_action_id", nullable = false)
    private Long uiActionId;
    ...
    public Long getUiActionId() { return uiActionId; }
    public void setUiActionId(Long uiActionId) { this.uiActionId = uiActionId; }
