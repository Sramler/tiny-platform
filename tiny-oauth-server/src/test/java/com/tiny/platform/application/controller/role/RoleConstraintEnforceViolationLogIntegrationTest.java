...
class RoleConstraintEnforceViolationLogIntegrationTest {
    ...
    void enforce_shouldBlockAndStillWriteViolationLog_queryableViaEndpoint() throws Exception {
        ...
        roleA.setCode("ROLE_RBAC3_ENFORCE_OBS_A_" + ts);
        roleA.setName("RBAC3 Enforce OBS A " + ts);
        ...
        roleB.setCode("ROLE_RBAC3_ENFORCE_OBS_B_" + ts);
        roleB.setName("RBAC3 Enforce OBS B " + ts);
