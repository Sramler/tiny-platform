...
| AUTH-P0-08 | P0 | 未登记api_endpoint不误伤 | 选择明确未登记接口，且旧 Guard 允许访问 | 不被统一守卫误拦 403（NOT_REGISTERED 分支保持现状） | integration | JWT（API优先，可补Session） | `ApiEndpointRequirementFilter` 未登记分支判定 | TBD | 0.5d | PASS (2026-03-27) |
